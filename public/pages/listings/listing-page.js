...
export function renderListingsPage({ title, listings, pageIndex, totalPages, onCardClick, onAddButtonClick, onSwipeLeft, onSwipeRight }) {
    ...
    `);
    onClickAddButton(onAddButtonClick);
